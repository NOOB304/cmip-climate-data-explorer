...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        version_glow = QGraphicsDropShadowEffect(self.sidebar_version)
        version_glow.setBlurRadius(7.0)
        version_glow.setColor(QColor(215, 226, 232, 90))
        version_glow.setOffset(0, 0)
        self.sidebar_version.setGraphicsEffect(version_glow)
